...
;(function () {
	...
	// login form handling
	$("#loginform #submit a#next").click(function(e){
		// Check if the user exists
		$.ajax({url: "/get_user?email_address="+encodeURI($('#loginform #emailaddress input').val()), 
			error: function(result){
				$('#loginform #firstname').removeClass('hide');
		...
		$("#loginform #submit a#login").removeClass('hide');
	});
	$("#loginform #submit a#login").click(function(e){
		...
		// register a new user and then redirect
			...
			post_body = {"email_address":$("#loginform #emailaddress input").val(),"first_name":$("#loginform #firstname input").val(),"last_name":$("#loginform #lastname input").val()};
